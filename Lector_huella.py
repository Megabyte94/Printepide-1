...
def VerifyUser():
    ...
    if r == ACK_SUCCESS and IsMasterUser(g_rx_buf[4]) == TRUE:
        ...
        sg.popup_ok("No se encontro registro de tu huella o esta mal posicionada en el lector, intentalo de nuevo", no_titlebar=True, location=(0,0), size=(1024,600), keep_on_top=True)
        print("no existe")
        AddUser()
        return ACK_NO_USER
